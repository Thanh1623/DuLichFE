...
function ModalViewHomeStay(props) {
    ...
    useEffect(() => {
        if (!_.isEmpty(dataView)) {
            ...
            setType(dataView.type_bed);
            setAddress(dataView.address);
            setContentHTML(dataView.ContentHTML);
            setContentMarkdown(dataView.ContentMarkDown);

            setImage(base64ToFile(`data:image/jpeg;base64,${dataView.homestay_image_base64}`));


            setImageP(`data:image/jpeg;base64,${dataView.homestay_image_base64}`);
            setDataImagePreview({
                url: `data:image/jpeg;base64,${dataView.homestay_image_base64}`,
            })
        }
    }, [dataView])
    ...
    //     if (validation === true) {
    //         let data = await putHome(dataView.homestay_id, title, address, price, type, contentHTML, contentMarkdown, image, map)
        ...
        <>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>View home</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
export default ModalViewHomeStay;